package com.epam.autocode.constants;
...
public class Constants {
    ...
    //    public static final String API_KEY = System.getenv("DIAL_API_KEY");
    public static final String API_KEY = "dial-lslpurmmxkdbfbebovz56tg4tja";
}